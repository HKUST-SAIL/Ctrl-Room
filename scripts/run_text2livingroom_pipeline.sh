...
RAW_DATASET_PATH=$RAW_DATASET_ROOT/test/livingroom/
train_stats_file=$RAW_DATASET_ROOT/train/livingroom/train_dataset_stats.json

LAYOUT_MODEL_PATH=ckpts/st3d_layout_livingroom.pt
...
PANOGEN_MODEL_PATH="ckpts/st3d_panorama_livingroom.ckpt"
