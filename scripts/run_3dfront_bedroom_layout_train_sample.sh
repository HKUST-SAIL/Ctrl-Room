...
mpiexec -n $NUM_GPUS python scripts/threed_front_room_layout_train.py \
    ...
    --log_dir "log/3dfront_bedroom/textconditional-0122/"
...
python scripts/threed_front_room_layout_sample.py \
    --model_path log/3dfront_bedroom/textconditional-0122/ema_0.9999_400000.pt \
     $MODEL_FLAGS \
     $DIFFUSION_FLAGS \
     --num_samples 1000 \
      --room_type $ROOM_TYPE \
      ...
      --config_file $CONFIG_FILE \
      --log_dir "log/3dfront_bedroom/textconditional-0122/sample_results"