...
import numpy as np
from egformer.Panoformer.model import *
...
class EGTransformer(nn.Module):
    ...
    def __init__(self, img_size=[512, 1024], patch_size=16, in_chans=3, num_classes=1000, embed_dim=96, depth=[2,2,6,2], split_size = [3,5,7],
        ...
        self.downsample1 = Merge_Block(dim=curr_dim, dim_out=curr_dim *2 , resolution = [img_size[0]//2, img_size[1]//2])
        ...
        self.downsample2 = Merge_Block(dim=curr_dim, dim_out=curr_dim*2, resolution = [img_size[0]//4, img_size[1]//4])
        ...
        self.downsample3 = Merge_Block(dim=curr_dim, dim_out=curr_dim*2, resolution = [img_size[0]//8, img_size[1]//8])
        ...
        self.downsample4 = Merge_Block(dim=curr_dim, dim_out=curr_dim * 2, resolution = [img_size[0]//16, img_size[1]//16])
        curr_dim = curr_dim*2
        ...
        self.tune5 = Tune_Block(dim=curr_dim * 2, dim_out=curr_dim, resolution = [img_size[0]//16, img_size[1]//16]) # Tune_5
        ...
        self.upsample6 = Merge_Block(dim=curr_dim, dim_out=curr_dim // 2, resolution = [img_size[0]//16, img_size[1]//16],scale_factor=2.)
        curr_dim = curr_dim // 2
...
class EGDepthModel(nn.Module):
    def __init__(self, **kwargs) -> None:
        ...
        self.module = EGTransformer(patch_size=4, 
                                    embed_dim=32, 
