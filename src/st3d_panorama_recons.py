...
def gen_depth_mesh(rgb: np.ndarray, device: str, depth_estimation_model: Union[PanoBiT, EGDepthModel],
...
def main(args):
    ...
    for i, img_folder in enumerate(input_folders_lst):
        ...
        pcl_filepath, poisson_mesh_filepath = gen_depth_mesh(sampled_img, device, depth_estimation_model, poisson_exe_path=args.poisson_exe_path, 
...
if __name__ == '__main__':
    ...
    parser.add_argument('--mesh_tex_exe_path',
                        type=str,
                        default='/app/libs/PanoTexturing/build/apps/pano_texrecon/panorecons')
    parser.add_argument('--use_egformer',
                        type=bool,
                        default=False)
